...
def data_reduction_prefixed_files_small(middlebox_module, testing_part_1):
    """ Tests that the WAN optimizer reduces data sent over the WAN.

    This test is the same as data_reduction_prefixed_files, except for the
    fact that it operates on a smaller file.
    ...
    filename = ["sample_short.txt", "prefix_sample_short.txt"]
